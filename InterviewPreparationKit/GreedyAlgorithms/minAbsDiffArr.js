...
We define the absolute difference between two elements, a[i] and a[j] 
...
create 3 pairs of numbers: [-2,2],[-2,4] and [2,4]. The absolute differences for 
these pairs are |(-2) - 2| = 4, |(-2) - 4| = 6 and |2-4| = 2. 
...
Explanation 0
With n = 3 integers in our array, we have three possible pairs: (3, -7), (3,0), 
and (-7,0). The absolute values of the differences between these pairs are as follows:
...
absolute values would still be the same. The smallest of these possible absolute differences is 3.
